test_that("process_data climate data completeness checks work correctly", {
  
  # Test 1: Check that cdate column must be character in DD/MM/YYYY format
  ...
  # Test 3: Check that xvar column has no missing data (NA or Inf)
  ...
  # Test that all checks work together
