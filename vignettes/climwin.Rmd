...
MassRand <- randwin(repeats = 5,
                    ...
                    type = "absolute", cutoff.day = 20, cutoff.month = 05,
                    stat = "mean",
                    func = "lin")
```
...
|  |response |climate |type     |stat |func |DeltaAICc |...  |
|:-|:--------|:-------|:--------|:----|:----|:---------|:----|
|1 |  Mass   |Temp    |absolute |max  |lin  |-5.13     |...  |
|2 |  Mass   |Temp    |absolute |mean |lin  |-3.17     |...  |
|3 |  Mass   |Temp    |absolute |max  |quad |-3.40     |...  |
|4 |  Mass   |Temp    |absolute |mean |quad |-3.67     |...  |
