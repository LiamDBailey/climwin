...
test_that("plot_window returns a ggplot object", {
  ...
  result <- plot_window(sample_data)
  expect_s3_class(result, "ggplot")
})
...
test_that("plot_window can take different values of cw1", {
  ...
  result1 <- plot_window(sample_data, cw1 = 0.5)
  result2 <- plot_window(sample_data, cw1 = 0.8)
  result3 <- plot_window(sample_data, cw1 = 0.95)
  ...
  result_default <- plot_window(sample_data)
